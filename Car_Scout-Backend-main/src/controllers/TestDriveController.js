...
const createTestDrive = async (req, res) => {
  try {
    ...
    res.status(500).json({ 
      message: "Internal Server Error during test drive booking", 
      error: err.message 
    });
  }
};
...
const getAllTestDrives = async (req, res) => {
  try {
    ...
    console.error("GET TEST DRIVES ERROR:", err);
    res.status(500).json({ 
      message: "Internal Server Error during test drive fetch", 
      error: err.message 
    });
  }
};
...
const updateTestDrive = async (req, res) => {
  try {
    ...
    res.status(500).json({ 
      message: "Internal Server Error during test drive update", 
      error: err.message 
    });
  }
};
