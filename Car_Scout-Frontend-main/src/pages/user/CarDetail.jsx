      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#111827] p-6 shadow-lg">
            <h1 className="mb-2 text-3xl font-bold flex items-center gap-4">
              {car.brand} {car.model}
              {car.status === "sold" && (
                <span className="rounded-full bg-red-500/20 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-red-400 border border-red-500/30 shadow-[0_0_20px_rgba(239,68,68,0.2)]">
                  Sold Out
                </span>
              )}
            </h1>
            ...
            <div className="mt-8 space-y-3">
              {car.status !== "sold" ? (
                <>
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="w-full rounded-xl bg-cyan-500 py-3.5 font-bold text-slate-950 transition hover:bg-cyan-400 shadow-lg shadow-cyan-500/20"
                    >
                      Make an Offer
                    </button>
                  </div>
                ...
                <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-center">
                  <p className="text-slate-400">This car has already been sold.</p>
                </div>
              )}
